...
โปรแกรมมอนิเตอร์ระบบบน menu bar ของ macOS อ่านค่าทุกอย่างจากเครื่องโดยตรง
...
แต่ละ dropdown คือ stack ของ **section**: หัวข้อซ้าย ค่าปัจจุบันชิดขวา กราฟเต็มความกว้าง
แล้วต่อด้วย legend กับช่วงเวลา
...
- **รูปแบบ fade** 4 แบบ
  - `Fade to clear` — ไล่จากสีไปโปร่งใส (ค่าเริ่มต้น)
...
ไม่ต้องใช้สิทธิ์ root ไม่มี helper daemon และไม่ได้ติดตั้ง privileged component ใด ๆ
...
ใช้ แก้ไข และแจกจ่ายต่อได้ รวมถึงเชิงพาณิชย์ โดยต้องคงไฟล์ licence กับ NOTICE ไว้
และระบุว่าแก้อะไรไป จุดที่ต่างจาก MIT คือมีการอนุญาตสิทธิบัตรจากผู้ร่วมพัฒนาด้วย
ซอฟต์แวร์นี้ให้มาตามสภาพ ไม่มีการรับประกัน

ไม่ได้มีความเกี่ยวข้องใด ๆ กับ Apache Software Foundation — ใช้แค่ตัวข้อความสัญญาอนุญาต
